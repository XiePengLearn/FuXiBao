...
public class FriendsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setStatusBar(FriendsActivity.this, R.color.theme_color_title);
    ...
    private void getPickABirdInfo(int num) {
        ...
        Request request = new Request.Builder()
                .url(HttpsApi.SERVER_URL + HttpsApi.URL_FRIEND)
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                LogUtilsxp.e2(TAG, "URL_FRIEND_result:" + responseString);
                runtDialog.dismiss();
