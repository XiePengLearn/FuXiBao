...
public class NoticeView extends ViewFlipper implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        // 内边距5dp
        setPadding(dp2px(1f), dp2px(1f), dp2px(1f), dp2px(1f));
        // 设置enter和leave动画
     ...
     * @param notices
     */
    public void addNotice(List<String> notices,List<String> id) {
        mNotices = notices;
        mId = id;
        removeAllViews();
    ...
    public void onClick(View v) {
        ...
        String noticeId = (String) mId.get(position);
        if (mOnNoticeClickListener != null) {
            mOnNoticeClickListener.onNotieClick(position, notice,noticeId);
    ...
    public interface OnNoticeClickListener {
        void onNotieClick(int position, String notice,String noticeId);
    }
