...
public class MenuLocation3Adapter extends BaseAdapter {
    ...
    private List<CountryBean.DataBean> menuDatas;
    ...
    public MenuLocation3Adapter(Context mContext, List<CountryBean.DataBean> menuDatas) {
    ...
    public void setData(List<CountryBean.DataBean> data) {
        this.menuDatas = data;
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CountryBean.DataBean dataBean = menuDatas.get(position);
