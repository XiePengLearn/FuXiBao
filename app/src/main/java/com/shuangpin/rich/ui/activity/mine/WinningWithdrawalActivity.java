...
public class WinningWithdrawalActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setStatusBar(WinningWithdrawalActivity.this, R.color.theme_color_title);

        mContext = WinningWithdrawalActivity.this;
        ...
        tv_fans_withdraw_record.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_fans_withdraw_record:
                ...
                Intent mIntent = new Intent(WinningWithdrawalActivity.this, TheWithdrawalOfSubsidiaryActivity.class);
