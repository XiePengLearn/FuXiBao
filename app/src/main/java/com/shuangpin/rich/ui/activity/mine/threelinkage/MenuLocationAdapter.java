...
public class MenuLocationAdapter extends BaseAdapter {
    private Context mContext;
    private  List<LocationBean.DataBean> menuDatas;
    ...
    public MenuLocationAdapter(Context mContext, List<LocationBean.DataBean> menuDatas) {
    ...
    public void setData(List<LocationBean.DataBean> data) {
        this.menuDatas = data;
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LocationBean.DataBean dataBean = menuDatas.get(position);
