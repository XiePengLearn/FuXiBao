...
import static com.shuangpin.R.id.iv_user_photo_1;
/*
逛街寻鸟
 */
...
public class TopLineFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected View createView(LayoutInflater inflater, ViewGroup container,
        ...
        mListMapDetail = (ListView) view.findViewById(R.id.lv_list_map_detail);

        mAgencyMap = (LinearLayout) view.findViewById(R.id.ll_agency_map);
        mAgencyList = (LinearLayout) view.findViewById(R.id.ll_agency_list);
        mLineMap = view.findViewById(R.id.line_map);
        mLineList = view.findViewById(R.id.line_list);
        ...
        StatusBarUtil.setStatusBar(mMainActivity, R.color.white);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            if (convertView == null) {
                ...
                holder.iv_user_photo_1 = (ImageView) convertView.findViewById(iv_user_photo_1);
            ...
            String bean = mDataList.get(position).getBean();
