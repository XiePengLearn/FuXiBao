...
package com.shuangpin.rich.zbor.camber;
...
//				int width = screenResolution.x * 3 / 4;//原生
...
//				int height = screenResolution.y * 3 / 4;//原生
...
//				int topOffset = (screenResolution.y - height) / 2;//原生
